...
import com.xcartdemo.drivermanager.DriverManager;
...
public class Utility extends DriverManager
{
    ...
    /*public void verifyingProductsArrangement(String actualList) throws InterruptedException
    {
        //List<WebElement> originalList = actualList;
        List<String> originalProductNameList = new ArrayList<>();
        originalProductNameList.add(actualList);
